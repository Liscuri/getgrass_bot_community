...
if __name__ == '__main__':
    ...
    github_label = tk.Label(labels_frame, text="Orginal GitHub Repository: https://github.com/ymmmmmmmm/getgrass_bot    ",
                            fg="blue")
    github_label.pack(side=tk.LEFT)

    referral_label = tk.Label(labels_frame,
                              text="Orginal Creator Referral Link: https://app.getgrass.io/register/?referralCode=0PhrIR8TAQX6IG4",
                              fg="red")
    ...
    labels_frame.pack()
    log_box.insert(tk.END, 'Please enter the correct user_id as per the instructions\n', 'info')
    log_box.insert(tk.END, 'The format for Socks5 Proxy is socks5://username:password@ip:port\n', 'info')
